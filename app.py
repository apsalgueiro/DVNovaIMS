...
"This visualization explores the economic tourism data of six European countries: France, Germany, Hungary, Portugal, Slovakia and Spain between the years of 2001 to 2019, concerning the evolution of the number of tourists, accommodations, jobs related to tourism and the impact on countries’ GDP."),
    ...
    html.Div([
      ...
      html.P("Evolution of the number of check-ins from resident and non-resident tourists for the selected countries during the range period of 19 years."),
      html.P("It is possible to see an increase of tourism check-ins from 2001 to 2019. This may occur because of a generalisation in tickets price and due to a wider spectrum of activity options.")    
   ...
   html.Div([
      ...
      html.P("Comparison between Number of Tourism Employees, Tourists Accommodation Facilities and Total check-ins per country and how these indicators evolve during 2001 until 2019."),
      html.P("Overall, the number of tourism accommodations is proportional to the number of tourism employees."),    
      ...
      html.P("Over the years, the tourism sector has increased its share in the Portugal’s economy, by representing 18% of its GDP in 2019."),    
   ...
   html.Div([
      ...
      html.P("Behaviour comparison between the chosen variables for each country in linear and logarithm scales related to the period range."),
      html.P("This chart enables the comparison of different variables to understand if there are significant changes in their proportions."),    
      ],style={'display': 'inline-block', 'width': "100%", 'height':"20%"}, className="control_label"),
   ...
   html.Div([
      ...
      html.P("There is a high correlation between the tourists’ check-in variables with almost all the tourism related variables.")
      ],style={'display': 'inline-block', 'width': "100%", 'height':"20%"}, className="control_label"),
  ...
  html.Div([
   ...
   html.H5("The tourism sector has been steadily growing as more people are keen to travel and the overall prices are becoming more affordable."
          "This has been quite important to Portugal, Germany and Spain, as they have increased in facilities and/or the tourism employees."),
